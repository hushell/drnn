...
my $list = "data_weizmann_horse/list.txt";

# the LAB color clusters file
my $cluster_file = "data_weizmann_horse/lab_clusters";
...
my $LFW_DIR= "data_weizmann_horse/Color";
#Superpixels
my $SP_DIR= "data_weizmann_horse/feat_superpixels";
#Ground Truth labels
my $LABEL_DIR="data_weizmann_horse/GroundTruth";

## These directories should have been created earlier by generate_textures.m and generate_PB.m
my $TEXTON_DIR= "data_weizmann_horse/parts_tex";
my $PB_DIR= "data_weizmann_horse/parts_pb";

## These directories will be generated 
# Superpixel features
my $FEATURES_DIR= "data_weizmann_horse/parts_spseg_features";
# Alternative representation of superpixels
my $SPMAT_DIR="data_weizmann_horse/parts_superpixels_mat";
# Alternative representation of ground truth
my $GT_DIR="data_weizmann_horse/parts_gt";
